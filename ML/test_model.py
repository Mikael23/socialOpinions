...
class TestModel:
    ...
    def testWithoutLora(self):
        ...
        # Suppose you retrieved opinions from your vector DB:
        opinions = """
        1. Daniel is very organized and always on time.
        2. Sometimes he overanalyzes small problems.
        3. His teammates say he is calm and respectful.
        4. He can be a bit blunt with feedback.
        """

        prompt = f"""
        Summarize the following opinions into a short personality overview.
        Focus on work habits, communication style, and strengths/weaknesses.
